...
const path = /signup/
const mockEmailInUseErrorError = (): void => Http.mockForbiddenError(path, 'POST')
...
describe('SignUp', () => {
  ...
  it('Should update account if valid credentials are provided', () => {
    mockSuccess()
    simulateValidSubmit()
